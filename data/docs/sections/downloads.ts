          ...
          data: {
            ...
            files: [
              ...
              },
              {
                ...
                description:
                  "Conjunto de datos curado con más de 50,000 imágenes de arte histórico y sus restauraciones",
                size: "1.2 GB",
                format: "ZIP",
                url: "#",
              },
              {
                ...
                description: "Pesos del modelo Neuro-Museo listos para usar en TensorFlow/Keras",
                size: "45.7 MB",
                format: "H5",
                url: "#",
              },
              ...
              },
              {
                ...
                description: "Resultados detallados de evaluación en formato CSV con análisis estadístico",
                size: "892 KB",
                format: "CSV",
                url: "#",
              },
              {
                ...
                description: "Instrucciones paso a paso para configurar el entorno de desarrollo",
                size: "1.1 MB",
                format: "PDF",
                url: "#",
              },
